...
void agregarElemento(vector<string> &conjunto, int &pos)
{
    string valor;
...
void editarElemento(vector<string> &conjunto, int &pos)
{
    if (pos == 0)
    {
...
void mostrarConjuntos(vector<string> &conjunto1, vector<string> &conjunto2)
{
...
void mostrarOperacion( vector<string> &resultado)
{
...
vector<string> unionConjuntos( vector<string> &conjunto1,  vector<string> &conjunto2)
{
...
vector<string> interseccionConjuntos( vector<string> &conjunto1,  vector<string> &conjunto2)
{
...
vector<string> diferenciaConjuntos( vector<string> &conjunto1,  vector<string> &conjunto2)
{
    vector<string> resultado;
    for ( string &elem : conjunto1)
    {
...
vector<string> complementoConjuntos( vector<string> &conjunto1,  vector<string> &conjunto2)
{
    return diferenciaConjuntos(conjunto2, conjunto1);
}

// Funciones para manipulación de conjuntos
// Función para borrar un elemento del conjunto
void borrarElemento(vector<string> &conjunto, int &pos)
{
    if (pos == 0)
    {
        cout << "No hay elementos en el conjunto" << endl;
...
void vaciarConjunto(vector<string> &conjunto, int &pos)
{
    conjunto.clear();
    pos = 0;
}