...
int main() // inicio del main
{
    ...
    while (flag) //inicio del while que controla el bucle principal
    {
        ...
        case '1': // Agregar elementos a un Conjunto
            ...
            if (opc == '1')
            {
                agregarElemento(conjunto1, pos1);
            }
            else if (opc == '2')
            {
                agregarElemento(conjunto2, pos2);
            }
            else
            {
        ...
        case '3': // Realizar operaciones
            ...
            else
            {
                ...
                {
                case '1': // Unión
                    CUnion = unionConjuntos(conjunto1, conjunto2); //realiza la operación de unión y guarda en CUnion
                    mostrarOperacion(CUnion); 
                    break;
                case '2': // Intersección
                    CInterseccion = interseccionConjuntos(conjunto1, conjunto2); //realiza la operación de intersección y guarda en CInterseccion
                    mostrarOperacion(CInterseccion); 
                    break;
                case '3': // Diferencia
                    CDiferencia = diferenciaConjuntos(conjunto1, conjunto2); //realiza la operación de diferencia y guarda en CDiferencia
                    mostrarOperacion(CDiferencia); 
                    break;
                case '4': // Complemento
                    CComplemento = complementoConjuntos(conjunto1, conjunto2); //realiza la operación de complemento y guarda en CComplemento
                    mostrarOperacion(CComplemento); 
                    break;
                default:
        ...
        case '4': // Editar elementos
            ...
            else
            {
                ...
                if (opc == '1')
                {
                    editarElemento(conjunto1, pos1);
                }
                else if (opc == '2')
                {
                    editarElemento(conjunto2, pos2);
                }
                else
                {
                    cout << "Opción no válida" << endl;
        ...
        case '5': // Borrar elementos
            ...
            else
            {
                ...
                if (opc == '1')
                {
                    borrarElemento(conjunto1, pos1);
                }
                else if (opc == '2')
                {
                    borrarElemento(conjunto2, pos2);
                }
                else
                {
                    cout << "Opción no válida" << endl;
        ...
        case '6': // Vaciar conjuntos
            ...
            else
            {
                ...
                if (opc == '1')
                {
                    vaciarConjunto(conjunto1, pos1);
                }
                else
                {
                    vaciarConjunto(conjunto2, pos2);
                }
            }
            break;
